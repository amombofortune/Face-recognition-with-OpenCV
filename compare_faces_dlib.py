"""
This script makes use of dlib library to calculate the 128D descriptor to be used for face recognition
...
#Load shape predictor, face encoder and face detector using dlib library
...
def compare_faces(encodings, encoding_to_check):
    """ Returns the distances when comparing a list of face encodings against a candidate check """
...
#Load images
known_image_1 = cv2.imread("Jayden_1.jpg")
known_image_2 = cv2.imread("Jayden_2.jpg")
known_image_3 = cv2.imread("Jayden_3.jpg")
known_image_4 = cv2.imread("obama.jpg")
unknown_image = cv2.imread("Jayden_4.jpg")
